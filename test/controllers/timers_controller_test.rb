...
class TimersControllerTest < ActionController::TestCase
  ...
  test "should create timer" do
    assert_difference('Timer.count') do
      post :create, timer: { end: @timer.end, list_id: @timer.list_id, start: @timer.start, test_id: @timer.test_id }
    end
  ...
  test "should update timer" do
    patch :update, id: @timer, timer: { end: @timer.end, list_id: @timer.list_id, start: @timer.start, test_id: @timer.test_id }
    assert_redirected_to timer_path(assigns(:timer))
  end
